...
import Task_module from '../../tasks/task.module.scss';
import Classnames from 'classnames';
import ConfettiFx_module from '../../fx/confetti-fx/confetti-fx.module.scss';
...
export const Lesson06 = () => {
    ...
    return (
        <div className={styles.root}>
            <Task />
            <div
                className={Classnames(styles.playground, styles.backgrounds)}
                id="playground"
            >
